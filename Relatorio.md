...
A primeira plataforma de cloud que tentei usar neste projeto foi justamente a própria Google Cloud Plataform, onde consegui executar perfeitamente os passos [4.1](#41--projeto), [4.2](#42--bucket) e [4.3](#43--criação-do-dataset-no-bigquery).
...
O Google Cloud Dataflow foi a última ferramenta de ETL que busquei antes de me estabelecer na solução final descrita neste trabalho. Depois de seguir com sucesso as etapas detalhadas em [4.1](#41--projeto), [4.2](#42--bucket) e [4.3](#43--criação-do-dataset-no-bigquery), enfrentei desafios ao tentar criar e executar meus jobs no Dataflow.
