...
# Dicionário para armazenar o dataframes por liga e ano
dfs_dict = {league: {} for league in leagues.values()}

# Criar uma lista vazia para adicionar todos os dataframes gerados
all_dfs = []
...
# Concatenando todos os dataframes verticalmente
